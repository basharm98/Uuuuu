...
bot_token = "7393655598:AAHZuZvNPhMnFK-HlpHjvZDyLvKyBFRJEqo" #bot token from @BotFather
SmmPanelApi = "6c50ece3090ddc73691c19edf2ae924d" # api key from eadysmmpanel.com you can change api link
bot = telebot.TeleBot(bot_token)
admin_user_id = 6556354444
welcome_bonus = 100
ref_bonus = 500
min_view = 100
max_view = 30000
required_channels = ['@R_O_L_I_X_0']  # more channel same as
payment_channel = "@R_O_L_I_X_0"
...
🆘 In case you have any problem, contact @WWW99W"""
...
💰 Pay with Bitcoin, USDT, BSC, BUSD,  ... 👉🏻 @R_O_L_I_X_0

💳️ Pay with Paypal, Paytm, WebMoney, Perfect Money, Payeer ... 👉🏻 @R_O_L_I_X_0
...
"""
    ...
    button1 = InlineKeyboardButton("💲 PayPal", url="https://t.me/WWW99W")
    button2 = InlineKeyboardButton("💳 Perfect Money",
                                   url="https://t.me/WWW99W")
    button6 = InlineKeyboardButton("💳 Webmoney", url="https://t.me/WWW99W")
    button3 = InlineKeyboardButton("💎 Bitcoin, Litecoin, USDT...",
                                   url="https://t.me/WWW99W")
    button4 = InlineKeyboardButton("💸 Paytm", url="https://t.me/WWW99W")
    button5 = InlineKeyboardButton("💰 Paytm", url="https://t.me/WWW99W")
